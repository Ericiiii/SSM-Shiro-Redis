package com.mayday.dto;

import com.mayday.enums.AppointStateEnum;
...
public class AppointExecution {
	...
	// 预约成功的构造器
	public AppointExecution(long bookId, AppointStateEnum stateEnum, AppointmentModel appointment) {
		this.bookId = bookId;
		this.state = stateEnum.getState();
		this.stateInfo = stateEnum.getStateInfo();

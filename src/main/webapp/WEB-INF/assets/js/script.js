function ui_elements() {
    ...
    $('#add-sticky').click(function () {
        ...
        var unique_id = $.gritter.add({
            ...
            image: '../../../../../../s3.amazonaws.com/twitter_production/profile_images/132499022/myface_bigger.jpg'/*tpa=http://s3.amazonaws.com/twitter_production/profile_images/132499022/myface_bigger.jpg*/,
    ...
    $('#add-regular').click(function () {
        ...
        $.gritter.add({
            ...
            // (string | optional) the image to display on the left
            image: '../../../../../../a0.twimg.com/profile_images/59268975/jquery_avatar_bigger.png'/*tpa=http://a0.twimg.com/profile_images/59268975/jquery_avatar_bigger.png*/,
            // (bool | optional) if you want it to fade out on its own or just sit there
            sticky: false,
            // (int | optional) the time you want it to be alive for before fading out
            time: ''
...
function ui_components() {
    $('label.tree-toggler').click(function () {
        $(this).parent().children('http://www.js-css.cn/divcss/admin/spadmin/assets/js/ul.tree').toggle(300);
    });
    $("[rel=tooltip]").tooltip();
    $("#popover-top").popover();
...
function login() {
    ...
    $('#user').click(function () {
        ...
        $.gritter.add({
            ...
            // (string | optional) the image to display on the left
            image: 'assets/img/person.png'/*tpa=http://www.js-css.cn/divcss/admin/spadmin/assets/js/assets/img/person.png*/,
            // (bool | optional) if you want it to fade out on its own or just sit there
            sticky: false,
            // (int | optional) the time you want it to be alive for before fading out
            time: ''
    ...
    $('#user2').click(function () {
        ...
        $.gritter.add({
            ...
            // (string | optional) the image to display on the left
            image: 'assets/img/person2.png'/*tpa=http://www.js-css.cn/divcss/admin/spadmin/assets/js/assets/img/person2.png*/,
            // (bool | optional) if you want it to fade out on its own or just sit there
            sticky: false,
            // (int | optional) the time you want it to be alive for before fading out
            time: ''
    ...
    $('#user3').click(function () {
        ...
        $.gritter.add({
            ...
            text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam fringilla, arcu ac mattis fermentum,.',
            // (string | optional) the image to display on the left
            image: 'assets/img/person3.png'/*tpa=http://www.js-css.cn/divcss/admin/spadmin/assets/js/assets/img/person3.png*/,
            // (bool | optional) if you want it to fade out on its own or just sit there
            sticky: false,
            // (int | optional) the time you want it to be alive for before fading out
            time: ''

 ...
 */
(function(e){var h=function(c,g){c=e(c);var b=this,a=e.extend({},e.fn.bootstrapWizard.defaults,g),f=null,d=null;this.fixNavigationButtons=function(){f.length||(d.find("a:first").tab("show"),f=d.find("li:first"));b.firstIndex()>=b.currentIndex()?e("li.previous",c).addClass("disabled"):e("li.previous",c).removeClass("disabled");b.currentIndex()>=b.navigationLength()?e("http://www.js-css.cn/divcss/admin/spadmin/assets/bootstrap-wizard/js/li.next",c).addClass("disabled"):e("http://www.js-css.cn/divcss/admin/spadmin/assets/bootstrap-wizard/js/li.next",c).removeClass("disabled");if(a.onTabShow&&"function"===typeof a.onTabShow&&!1===a.onTabShow(f,
